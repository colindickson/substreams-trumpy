    ...
    pub mod functions {
        ...
        impl BatchLimit {
            const METHOD_ID: [u8; 4] = [149u8, 89u8, 192u8, 189u8];
            pub fn decode(
        ...
        impl substreams_ethereum::Function for BatchLimit {
            const NAME: &'static str = "BATCH_LIMIT";
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ContractAdmin {}
        impl ContractAdmin {
            const METHOD_ID: [u8; 4] = [143u8, 197u8, 144u8, 20u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for ContractAdmin {
            const NAME: &'static str = "CONTRACT_ADMIN";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for ContractAdmin {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct OperatorFilterRegistry {}
        impl OperatorFilterRegistry {
            const METHOD_ID: [u8; 4] = [65u8, 244u8, 52u8, 52u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for OperatorFilterRegistry {
            const NAME: &'static str = "OPERATOR_FILTER_REGISTRY";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for OperatorFilterRegistry {
        ...
        pub struct Freeze {}
        impl Freeze {
            const METHOD_ID: [u8; 4] = [98u8, 165u8, 175u8, 59u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Freeze {
        ...
        pub struct Frozen {}
        impl Frozen {
            const METHOD_ID: [u8; 4] = [5u8, 79u8, 125u8, 156u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Frozen {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for Frozen {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct MintSeveral {
            pub minter: Vec<u8>,
            pub number_of_tokens: substreams::scalar::BigInt,
        }
        impl MintSeveral {
            const METHOD_ID: [u8; 4] = [8u8, 251u8, 150u8, 109u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for MintSeveral {
            const NAME: &'static str = "mintSeveral";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl NextToken {
            const METHOD_ID: [u8; 4] = [148u8, 153u8, 172u8, 84u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for NextToken {
            const NAME: &'static str = "nextToken";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.sale_price.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                    ],
                );
        ...
        impl SetBaseUri {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::String(self.new_base_uri.clone())],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetContractUri {
            pub uri: String,
        }
        impl SetContractUri {
            const METHOD_ID: [u8; 4] = [147u8, 142u8, 61u8, 123u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetContractUri {
            const NAME: &'static str = "setContractURI";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Shares {
            const METHOD_ID: [u8; 4] = [87u8, 168u8, 88u8, 252u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SplitErc20Payment {
            pub erc20: Vec<u8>,
        }
        impl SplitErc20Payment {
            const METHOD_ID: [u8; 4] = [48u8, 243u8, 56u8, 245u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::Address(ethabi::Address::from_slice(&self.erc20))],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
        ...
        impl substreams_ethereum::Function for SplitErc20Payment {
            const NAME: &'static str = "split_erc20_payment";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SplitPayment {
            const METHOD_ID: [u8; 4] = [88u8, 208u8, 137u8, 179u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for SplitPayment {
            const NAME: &'static str = "split_payment";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TokenBaseUri {}
        impl TokenBaseUri {
            const METHOD_ID: [u8; 4] = [78u8, 153u8, 184u8, 0u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TokenBaseUri {
            const NAME: &'static str = "tokenBaseURI";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<String> for TokenBaseUri {
            fn output(data: &[u8]) -> Result<String, String> {
                Self::output(data)
            }
        }
        ...
        impl TokenExists {
            const METHOD_ID: [u8; 4] = [0u8, 146u8, 63u8, 158u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for TokenExists {
            const NAME: &'static str = "tokenExists";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for TokenExists {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        impl WithdrawBatch {
            const METHOD_ID: [u8; 4] = [156u8, 141u8, 65u8, 86u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl WithdrawnTokens {
            const METHOD_ID: [u8; 4] = [98u8, 136u8, 207u8, 73u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for WithdrawnTokens {
            const NAME: &'static str = "withdrawnTokens";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for WithdrawnTokens {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
    ...
    pub mod events {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ContractUriChanged {
            pub uri: String,
        }
        impl ContractUriChanged {
            const TOPIC_ID: [u8; 32] = [
                213u8,
                238u8,
                94u8,
        ...
        impl substreams_ethereum::Event for ContractUriChanged {
            const NAME: &'static str = "ContractURIChanged";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for MetadataFrozen {
            const NAME: &'static str = "MetadataFrozen";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for PaymentReceived {
            const NAME: &'static str = "PaymentReceived";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
